...
// Package Declaration (SystemVerilog-2009)
package counter_pkg;
  parameter WIDTH = 4;
  ...
  // Class Declaration with Virtual Methods
  virtual class CounterTransaction;
...
// Interface Declaration (SystemVerilog-2009)
interface counter_if (
  ...
  // Clocking Block (SystemVerilog-2009)
...
// Module Declaration: Counter (SystemVerilog-2009)
module counter import counter_pkg::*; (
  ...
  // Covergroup (SystemVerilog-2009, fails 2005 parser)
  ...
  always @(posedge ifc.clk or posedge ifc.rst) begin
    if (ifc.rst) begin
      ...
      // Random Case (SystemVerilog-2009, fails 2005 parser)
      randcase
        50: next_state <= (ifc.en) ? RUNNING : IDLE;
        30: next_state <= (ifc.en) ? RUNNING : STOPPED;
        20: next_state <= IDLE;
      endcase
    end
  end
...
// Program Declaration: Testbench (SystemVerilog-2009)
